...
const AddEmployeeEmployementDetails: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const department = await getDepartments(contextClientID, contaxtBranchID);
            ...
            setIsLoading(false);
console.log("branch id is ----",contaxtBranchID);
...
async function getDepartments(client_id:any, branch_id:any) {
