  ...
  try {
    ...
    if (role_id! && role_id == "1") {
      ...
      return NextResponse.json({
        ...
        teamDetails: platform && platform != "web" ? await funGetTeamDetails(customer_id):""
